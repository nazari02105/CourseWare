            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-4">
                    <div class="login-wrap p-0">
                        <form action="/professor/{{ $id }}" method="POST" class="signin-form">
                            @method("patch")
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input style="font-size: 20px" name="experience" type="number" class="form-control" placeholder="Experience" required value="{{ $experience }}">
                            </div>
                            @error('experience')
                            <div class="alert alert-danger" style="font-size: 12px">{{ "- ".$message }}</div>
                            @enderror
